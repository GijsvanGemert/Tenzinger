...
class __TwigTemplate_7a68c650764c8125684119f665a59a3d2bb2f27e3b3ef26a27714283f4cac594 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    ";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("IS_AUTHENTICATED_FULLY")) {
            // line 13
            echo "        <h1>You are currently logged in as ";
...
";
    ...
    {
        return array (  108 => 16,  103 => 14,  98 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    {% if is_granted('IS_AUTHENTICATED_FULLY') %}
        <h1>You are currently logged in as {{ app.user.email }}</h1>
        <p><a href=\"{{ path('app_logout') }}\">Logout</a><p>
    {% endif %}
</div>
{% endblock %}

", "welcome/index.html.twig", "/Applications/MAMP/htdocs/Tenzinger/templates/welcome/index.html.twig");
    }
}
