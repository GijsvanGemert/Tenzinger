...
class __TwigTemplate_dca1ca0e5093dffa5773f7f33c0be9881e5ced0f6750ed4cb8af9938b603883a extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 13
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["regform"]) || array_key_exists("regform", $context) ? $context["regform"] : (function () { throw new RuntimeError('Variable "regform" does not exist.', 13, $this->source); })()), 'form');
        echo "
<br>
</div>
...
{% endblock %}
", "registration/index.html.twig", "/Applications/MAMP/htdocs/Tenzinger/templates/registration/index.html.twig");
    }
}
